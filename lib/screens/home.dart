...
class _HomeState extends State<Home> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Color(0xFFEDE7F6), // светло-фиолетовый цвет
      appBar: _buildAppBar(),
      body: Stack(
        children: [
          Container(
  ...
  void _showCompletionDialog(String previousTask) {
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title: Text("Congratulations, well done!"),
          content: Text("You completed the task, don't forget to complete the following task: $previousTask"),
          actions: <Widget>[
            TextButton(
              child: Text("Ок"),
              onPressed: () {
